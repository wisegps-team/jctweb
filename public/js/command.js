    ...
    var cmdId = setInterval(function () {
        ...
        var fields = [
            ...
            },
            {
                ...
                display: 'UserDefined',
                render: function (obj) {
                    return (obj.aData ? obj.aData.device[0].vehicleName : obj.device[0].vehicleName) || i18next.t("monitor.no_device");
                }
            },
            {
        ...
        t = new _dataTable(div, '_iotCommand', fields, query, '-createdAt', $('#commandKey'), 'did', buttons, uButtons, lookup);
        t.createHeader();
